...
!function(e,t){"use strict";function n(){return{require:[t,"ngModel"],restrict:"A",controller:r}}function r(e,n,r,i,o,a,s,l,c){function u(e){function t(e){var t=x.toModel.parse(e||"");return t}function n(e){var t=E.toView.parse(e||"");return t.join("")}function r(e,t){function n(e){~r||(r=e)}if(t)return e.join("");var r=-1,i=$.length;e.forEach(function(e,t){var r=$[t];r!==e&&(t>=i?n(t+1,"New Token, set cursor after it"):e===$[t+1]?n(t,"Removed Token, set cursor before next"):n(t+1,"Inserted Token, set cursor after next"),$[t]=e)}),i>e.length&&(n(e.length,"Was truncated: set after last new token"),$.splice(e.length));var o=e.join("");return f(o,r),o}var i=angular.isArray(e.commonExp)?e.commonExp:[e.commonExp],o=i.slice(),s=i.slice();e.maps.forEach(function(e){var t=e.reg[0];t.type=e.type||"param_mapping",t.template=e.tpl[1],t.mapping=e.vm,o.push(t);var n=e.reg[1];n.type=e.type||"param_mapping",n.template=e.tpl[0],n.mapping=e.mv,s.push(n)}),x=l.getRepeater(o,!0),E=l.getRepeater(s,!0),x.toModel=l.getMapping(o,!0),E.toView=l.getMapping(s,!0);var c=[t,r],u=[n];a.fillListProcesser(c,w.$parsers),a.fillListProcesser(c,P),a.fillListProcesser(u,w.$formatters),a.fillListProcesser(u,M),window.vm=t,window.mv=n}function p(e){for(var t=M.length,n=e;t--;)n=M[t](n,!0);return n}function f(e,t){var n=p(e);n!==w.$viewValue&&(w.$setViewValue(n),w.$render(),g(t))}function g(e){if(~e&&"undefined"!=typeof e){var t=$.map(p).slice(0,e).join("").length;o(function(){s.setSelection(n,t,t,!0),S=t})}}function v(t){var r=s.getSelection(n),i=$.map(p);"undefined"==typeof r.start&&(r.end=r.start=i.join("").length);for(var a=null,l=null,c=0,u=0,f=$.length;f>=c&&(u==r.start&&null===a||u>r.start&&null===a&&(a=c-1),u>=r.end&&null===l&&(l=c),c!=f);c++){var g=$[c];u+=p(g).length}null===a&&(a=l),$.splice(a,l-a,t),i.splice(a,l-a,t),y.assign(e,$.join("")),o(function(){var e=i.slice(0,a).join("").length+p(t).length;s.setSelection(n,e,e,!0)})}function h(){d()}function m(e){d(p(e))}function d(t){"undefined"==typeof t&&(t="");var n=x.toModel.parse(t);$.length=0,n.forEach(function(e){$.push(e)}),y.assign(e,$.join(""))}var w=n.controller("ngModel"),$=[],y=i(r.ngModel),j=i(r[t])(e),P=[],M=[];angular.extend(j,{addToken:v,setModelValue:m,setViewValue:d,clear:h}),u(j.modelviews);var x,E,S=0}function i(){function e(e,r){return Array.isArray(e)?(e.forEach(t(r)),n):n}function t(e){function t(t){var o="push";if(Array.isArray(t)){if(o=t[i],!~["push","unshift"].indexOf(o))throw new Error(n.name+": Wrong method ["+o+"] - push|unshift expected");t=t[r]}e[o](t)}var r=0,i=1;return t}var n=this;n.$name="ParseFormatService",this.getListProcesser=t,this.fillListProcesser=e}e.directive(t,n),e.service("ParseFormatService",i),n.$inject=[],r.$inject=["$scope","$element","$attrs","$parse","$timeout","ParseFormatService","InputSelection","ParserFactory","MappingParser"],i.$inject=[]}(angular.module("arth.tokenized",["arth.parser.svc","arth.svc.InputSelection"]),"arthTokenized");
